...
//     document.title = `${blog.title} | Surunga Medicine`;
...
//     updateTag("og:title", blog.title);
//     updateTag("og:description", blog.content.substring(0, 150));
//     updateTag("og:image", blog.image || "/placeholder.svg");
//     updateTag("og:url", getBlogUrl(blog));
//   };
...
//                     updateMetaTags(expandedBlog === index ? null : blog); // Update meta tags when blog is expanded
//                   }}
//                 >
//                   {expandedBlog === index ? (
//                     <>
...
//                     description={blog?.content?.substring(0, 150) || "Read more about healthcare insights from Surunga Medicine Center"}
...
//       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-8">
//         {blogs.map((blog, index) => {
//           const blogUrl = getBlogUrl(blog, index);
...
//                       onClick={() => shareOnFacebook(blogUrl)}
//                     >
...
//                       onClick={() => shareOnTwitter(blogUrl, blog.title)}
//                     >
...
//                       onClick={() => shareOnWhatsApp(blogUrl, blog.title)}
//                     >
...
//                       onClick={() => shareOnInstagram(blogUrl)}
//                     >
...
//   useEffect(() => {
//     // Update title and meta tags manually
//     if (expandedBlog !== null) {
//       const currentBlog = blogs[expandedBlog];
//       document.title = currentBlog.title || "Surunga Medicine Center Blog";

//       // Update meta tags
//       const descriptionMetaTag = document.querySelector('meta[name="description"]');
//       if (descriptionMetaTag) {
//         descriptionMetaTag.setAttribute("content", currentBlog.content.substring(0, 150));
//       } else {
//         const newDescriptionMetaTag = document.createElement("meta");
//         newDescriptionMetaTag.setAttribute("name", "description");
//         newDescriptionMetaTag.setAttribute("content", currentBlog.content.substring(0, 150));
//         document.head.appendChild(newDescriptionMetaTag);
//       }

//       const ogTitleMetaTag = document.querySelector('meta[property="og:title"]');
//       if (ogTitleMetaTag) {
//         ogTitleMetaTag.setAttribute("content", currentBlog.title);
//       } else {
//         const newOgTitleMetaTag = document.createElement("meta");
//         newOgTitleMetaTag.setAttribute("property", "og:title");
//         newOgTitleMetaTag.setAttribute("content", currentBlog.title);
